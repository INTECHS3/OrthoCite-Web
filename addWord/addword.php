...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?page=addWord">OrthoCité | Ajouter des mots</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.php?page=addWord"><i class="fa fa-plus fa-fw"></i> Ajouter Des Mots</a>
                        </li>  
                        <li>
    ...
    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ajouter des mots</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <script src="addWord/bower_components/raphael/raphael-min.js"></script>
    <script src="addWord/bower_components/morrisjs/morris.min.js"></script>
    <script src="addWord/js/morris-data.js"></script>
